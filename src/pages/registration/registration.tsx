...
const Registration: FC = () => {
  ...
  const [directions] = useState([{ name: "前端" }, { name: "后台" }]);
      ...
      <View className="content">
        ...
        >
          ...
          <View className="form-item">
            ...
            <Input name="userName" placeholder="请输入姓名" className="input" />
          </View>
            ...
            >
              <View className="picker-view">
                {directions[directionIndex]
                  ? directions[directionIndex].name
                  : "请选择学习方向"}
              </View>
            </Picker>
          </View>
          ...
          <View className="form-buttons">
            <button form-type="submit" className="submit-btn">
              提交
            </button>
            <button form-type="reset" className="reset-btn">
              重置
            </button>
          </View>
        </Form>
